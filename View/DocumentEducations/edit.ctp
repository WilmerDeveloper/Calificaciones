                ...
                <div class="edit-form">
                    <table border="0" class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="http://192.168.1.96:85/ASPIRANTE/DescargarArchivo?URLArchivo=E:\DOCUMENTOS_ASPIRANTES\<?php echo $this->data['Candidate']['NRODOCUMENTO'];?>\<?php echo $this->data['DocumentEducation']['DOCUMENTO'];?>">
                                        <?php 
                                        echo $this->data['DocumentEducation']['DOCUMENTO']; 
                                        ?>
                                    </a>
                                </td>
                            </tr>
