...
<section class="section-app">
    ...
    <?php echo isset($candidate[0][0]['NRODOCUMENTO'])? $this->Form->hidden('Reclamation.NRODOCUMENTO', array('value' => $candidate[0][0]['NRODOCUMENTO'])):""; ?>
    <?php echo isset($candidate[0][0]['NRODOCUMENTO'])? $this->Form->input('Reclamation.justificacion', array('label' => '', 'class' => 'form-control', 'type' => 'textarea', 'placeholder' => 'Justificación (max 2000 caracteres)')):""; ?>   
    <br>
    <?php
    echo isset($candidate[0][0]['NRODOCUMENTO']) ? $this->Form->file('Reclamation.archivo', array('label' => 'Adjuntar soporte',
        'class' => 'form-control',
